...
function Home() {
  return (
    ...
    <div className="home2">
      ...
      <div>
        <p>
          Greetings! I'm Bhanu Pratap Patkar, on the path to becoming a software engineer. Enthusiastically delving into React, I'm crafting a website that not only showcases my skills but also aims to provide valuable services to users.
        </p>
      </div>
    </div>
